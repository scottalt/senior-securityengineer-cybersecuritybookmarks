...
Mapping attack surface, harvesting intel, and finding what's exposed before anyone else does.

| Resource | What it does |
| --- | --- |
| **[Shodan](https://www.shodan.io)** | Search engine for internet-connected devices and exposed services. |
| **[Censys](https://search.censys.io)** | Attack-surface search across hosts, certs, and services. |
| **[crt.sh](https://crt.sh)** | Certificate transparency search to uncover subdomains. |
| **[DNSdumpster](https://dnsdumpster.com)** | Free DNS recon and subdomain mapping. |
| **[ViewDNS.info](https://viewdns.info)** | Bundle of DNS, WHOIS, and reverse-IP lookup tools. |
| **[theHarvester](https://github.com/laramies/theHarvester)** | Emails, subdomains, and names from public sources. |
| **[OSINT Framework](https://osintframework.com)** | Categorized directory of OSINT tools for any lead. |
| **[Hunter](https://hunter.io)** | Find and verify professional email addresses. |
| **[Wappalyzer](https://www.wappalyzer.com)** | Fingerprint the tech stack behind any website. |
| **[Wayback Machine](https://archive.org/web)** | Historical snapshots of pages and deleted content. |
...
| Resource | What it does |
| --- | --- |
| **[HackTricks](https://book.hacktricks.xyz)** | The offensive-security bible, methodology for everything. |
| **[PayloadsAllTheThings](https://github.com/swisskyrepo/PayloadsAllTheThings)** | Payloads and bypasses for every vuln class. |
| **[SecLists](https://github.com/danielmiessler/SecLists)** | The security tester's collection of wordlists. |
| **[GTFOBins](https://gtfobins.github.io)** | Unix binaries abused to bypass local restrictions. |
| **[LOLBAS](https://lolbas-project.github.io)** | Living-off-the-land binaries and scripts for Windows. |
| **[Exploit-DB](https://www.exploit-db.com)** | Archive of public exploits and vulnerable software. |
...
| Resource | What it does |
| --- | --- |
| **[winPEAS (PEASS-ng)](https://github.com/carlospolop/PEASS-ng/tree/master/winPEAS)** | Automated Windows privesc enumeration. |
...
Detonate, inspect, and verify the unknown.

| Resource | What it does |
| --- | --- |
| **[VirusTotal](https://www.virustotal.com)** | Multi-engine file and URL reputation. |
| **[ANY.RUN](https://app.any.run)** | Interactive online malware sandbox. |
| **[Hybrid Analysis](https://www.hybrid-analysis.com)** | Automated analysis powered by Falcon Sandbox. |
| **[Talos File Reputation](https://talosintelligence.com/talos_file_reputation)** | Cisco Talos hash and file lookup. |
...
Where I keep up with what broke today.

| Resource | What it does |
| --- | --- |
| **[BleepingComputer](https://www.bleepingcomputer.com)** | Breach news, malware coverage, and support. |
| **[The Hacker News](https://thehackernews.com)** | Fast, widely-read security news. |
| **[Krebs on Security](https://krebsonsecurity.com)** | Deep investigative security journalism. |
...
1. Fork the repo
2. Add your resource to the right category table, alphabetical within reason
3. Keep the one-line description short and honest
...
These resources are shared for **education, research, and authorized security testing only**. Only test systems you own or have explicit written permission to assess. You are responsible for how you use them.
